...
public class MusicApp implements PhoneApp {
    ...
    public ItemStack getIcon(Player viewer) {
        return GuiUtil.icon("play_music", getDisplayName(), "§7Play music");
    }
